...
#include "window_msg/msg/detail/sphere__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_window_msg
cdr_serialize(
  const window_msg::msg::Sphere & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  window_msg::msg::Sphere & ros_message)
{
  // Member: center
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = window_msg::msg::Sphere;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const window_msg::msg::Sphere *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<window_msg::msg::Sphere *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_window_msg
const rosidl_message_type_support_t *
get_message_type_support_handle<window_msg::msg::Sphere>()
{
  return &window_msg::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, window_msg, msg, Sphere)() {
  return &window_msg::msg::typesupport_fastrtps_cpp::_Sphere__handle;
}
